                    ...
                    <div class="text-md-end">
                        ...
                        @if($order->payment_method)
                            <div class="text-dark-50 small mt-1">
                                ...
                                ({{ ucfirst($order->payment_status ?? $order->status_online_pay ?? 'unpaid') }})
                            </div>
                        @endif
                        @if($order->transaction_id)
                            <div class="text-dark-50 small mt-1">Transaction ID: {{ $order->transaction_id }}</div>
                        @endif
                    ...
                    <div class="col-lg-5">
                        @if($order->status === 'rejected')
                            <div class="alert alert-danger">
                                ...
                                @if($order->rejection_reason)<br>Reason: {{ $order->rejection_reason }}@endif
                            </div>
                        @endif
                        <div class="mb-3">
