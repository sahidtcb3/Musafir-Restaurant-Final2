                        ...
                        <div class="row">
                            <div class="col-lg-7 col-md-12 col-sm-12">
                                <div class="banner_content2 text_white">
                                    <h2 class="staggered-animation" data-animation="fadeInUp" data-animation-delay="0.2s">Bangladeshi Food Heaven</h2>
                                    <p class="staggered-animation" data-animation="fadeInUp" data-animation-delay="0.4s">Taste the soul of Bengal in every delicious dish. <br class="d-none d-md-block" /> Tradition, comfort, and flavor—served together.</p>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7 col-md-12 col-sm-12 text-center">
                                <div class="banner_content2 text_white">
                                    ...
                                    <p class="staggered-animation" data-animation="fadeInUp" data-animation-delay="0.4s">Indulge in biryani, kacchi, and other mouthwatering Bangladeshi dishes, <br class="d-none d-md-block" /> infused with authentic spices and crafted to delight your taste buds.</p>
                                    <a class="btn btn-default rounded-0 staggered-animation" href="{{ route('menu') }}" data-animation="fadeInUp" data-animation-delay="0.6s">Order Online</a>
                        ...
                        <div class="row justify-content-md-end">
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <div class="banner_content2 text_white">
                                    ...
                                    <p class="staggered-animation" data-animation="fadeInUp" data-animation-delay="0.4s">From sizzling suya to hearty stews, enjoy Bangladeshi dishes made to bring joy <br class="d-none d-md-block" /> to every occasion and appetite.</p>
                                    <a class="btn btn-default rounded-0 staggered-animation" href="{{ route('menu') }}" data-animation="fadeInUp" data-animation-delay="0.6s">Order Online</a>
                                    <a class="btn btn-white rounded-0 staggered-animation" href="{{ route('contact') }}" data-animation="fadeInUp" data-animation-delay="0.6s">Contact Us</a>
                                </div>
                            </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-7 col-md-9 animation text-center" data-animation="fadeInUp" data-animation-delay="0.02s">
                ...
                <p class="text-white">Celebrate the joy of dining with authentic Bangladeshei dishes, crafted to bring families and friends closer with every bite.</p>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 animation" data-animation="fadeInUp" data-animation-delay="0.2s">
                ...
                <p class="text-center leads">Explore the stories behind our rich Bangladeshi flavors, our passion for suya, and the art of charcoal grilling.</p>
            </div>
        </div>
        <div class="row justify-content-center">
