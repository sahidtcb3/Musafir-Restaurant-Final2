    	...
    	<div class="row align-items-center">
            <div class="col-lg-12">
                <div class="about_box box_shadow1">
                    ...
                    <p>Welcome to {{ config('site.name') }} Restaurant, where we present the rich and vibrant flavors of Bangladeshi cuisine with elegance and warmth. From aromatic Kacchi Biryani to tender Chicken Grill and flavorful Bhuna dishes, every plate is crafted to elevate your dining experience.</p>
                    <p>At {{ config('site.name') }} Restaurant, we believe in authenticity, innovation, and the freshest ingredients. Step in and savor the true essence of Bangladesh's culinary heritage—served with passion.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-8 animation" data-animation="fadeInUp" data-animation-delay="0.02s">
                        ...
                        <p class="text-white">Embark on a culinary journey with Musafir Restaurant, where we celebrate the rich and diverse flavors of Bangladesh. Our signature Kacchi Biryani, crafted with authentic spices and traditional techniques, offers a unique and unforgettable dining experience.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="icon_box icon_box_style1 text-center animation" data-animation="fadeInUp" data-animation-delay="0.02s">
                    ...
                    <div class="icon_box_content">
                        <h5 class="text-uppercase">Authentic Bangladeshi Cuisine</h5>
                        <p>Relish the flavors of traditional Bangladeshi meals, lovingly prepared to preserve our rich culinary heritage.</p>
                    </div>
                </div>
            </div>
