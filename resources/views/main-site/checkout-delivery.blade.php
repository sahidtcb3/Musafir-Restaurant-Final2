...
@push('scripts')
    ...
    <script>
      ...
      // Address form handler (manual entry - no Google Maps)
      function initCheckoutDeliveryLookups() {
          // Placeholder for future address validation
          // Currently using manual address entry without autocomplete
      }

      // Expose init function globally for consistency
      window.initCheckoutDeliveryLookups = initCheckoutDeliveryLookups;
    </script>

    {{-- Address form (no external APIs) --}}
