...
class CustomerController extends Controller
{
    ...
    public function orders($filter = 'all')
    {
        ...
        $allowedFilters = ['all', 'pending', 'confirmed', 'rejected', 'preparing', 'ready', 'out_for_delivery', 'delivered', 'cancelled'];
        ...
        // Customers can track every order they own, including unpaid cash and bKash orders.
