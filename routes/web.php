...
Route::prefix('admin')->middleware(RedirectIfNotAdmin::class)->group(function () {
    ...
    Route::post('orders/update/{id}', [OrderController::class, 'update'])->name('admin.orders.update')->middleware(CheckRoleAdmin::class);
    Route::post('orders/{id}/confirm', [OrderController::class, 'confirm'])->name('admin.orders.confirm')->middleware(CheckRoleAdmin::class);
    Route::post('orders/{id}/reject', [OrderController::class, 'reject'])->name('admin.orders.reject')->middleware(CheckRoleAdmin::class);
    Route::post('orders/{id}/payment-status', [OrderController::class, 'updatePaymentStatus'])->name('admin.orders.payment-status')->middleware(CheckRoleAdmin::class);
